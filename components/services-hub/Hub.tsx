...
import { ArrowDown, ArrowRight, ArrowUpRight, BedDouble, Blinds, Building2, ClipboardList, CookingPot, Droplets, HeartHandshake, Grid3x3, Home, MapPin, Sparkles, Store, type LucideIcon } from "lucide-react";
import {
  choiceFactors,
  commercialKeys,
  hrefFor,
...
const rowIcons: Partial<Record<ServiceKey, LucideIcon>> = { house: Home, oven: CookingPot, mattress: BedDouble, tile: Grid3x3, blinds: Blinds, pressure: Droplets, ndis: HeartHandshake };
